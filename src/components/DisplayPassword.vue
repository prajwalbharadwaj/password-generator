...
<template>
  <div
    class="bg-white shadow text-2xl font-semibold rounded-2xl col-span-12 flex items-center justify-between px-6 h-24">
    <div class="overflow-scroll whitespace-nowrap no-scrollbar tracking-[.075em]">{{ password }}</div>
